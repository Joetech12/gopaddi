...
const Footer = () => {
  return (
    <div className='bg-primary  pt-[20px] mt-[0px]'>
      ...
      {/* <footer className='px-[80px] footer p-10 bg-primary text-white w-full justify-center md:max-w-7xl mx-auto border-t border-gray-400/50'>
